...
- Реализованы централизованная brand-конфигурация, SVG-логотипы, favicon/manifest и страницы `/ru/about`, `/en/about`.
- About показывает безопасные версии frontend/backend, лицензию, автора, ссылки и состояние служб.
- Запланировано: финальный дизайн логотипа, опциональная организация/публичный сайт для конкретных deployments и расширенная страница справки.
