...
import { AdminCard, AdminIcon, AdminPageHeader, AdminPageShell, AdminTableContainer } from "./AdminUI";
...
export function AdminAudit({ dictionary, locale }: AdminAuditProps) {
  ...
  return (
    <AdminPageShell ariaLabel={dictionary.audit.title} className="admin-audit-page" wide>
        <AdminPageHeader backHref={`/${locale}/dashboard`} backLabel={dictionary.adminUi.backToDashboard} description={dictionary.adminUi.pageDescriptions.audit} title={dictionary.audit.title} />
        {error ? <p className="form-error">{error}</p> : null}

        <form className="audit-filters admin-card" onSubmit={applyFilters}>
          ...
          <div className="actions"><button className="primary-button" type="submit">{dictionary.audit.apply}</button><button className="secondary-link" onClick={() => { setDraft(emptyFilters); setFilters(emptyFilters); }} type="button">{dictionary.audit.reset}</button><button className="secondary-link" onClick={() => void exportCsv()} type="button"><AdminIcon name="download" />{dictionary.audit.export}</button></div>
        </form>

        <AdminCard className="admin-audit-table-card"><AdminTableContainer className="audit-table-wrap">
