...
from app.api.routes.directory_imports import router as directory_imports_router
...
api_router.include_router(
    directory_imports_router, prefix="/directory/imports", tags=["directory", "directory-import"]
)
